...
admin.site.site_header = 'Data Center Visitor Management System'
admin.site.index_title = 'Admin Dashboard'
admin.site.site_title = 'BSrE DCVMS'
...
class VisitorAdmin(admin.ModelAdmin):
  ...
  list_filter = ('site','checkout', 'checkin', 'role',)
...
class HistoryAdmin(admin.ModelAdmin):
  ...
  readonly_fields = ['site', 'visitor', 'checkin','checkout']
  ordering = ('-checkout',)
